 ...
 */
class Char extends AbstractSection
{
    /**
     * Constructor
     *
    ...
    public function pullXML()
    {
        ...
        try {
            ...
            foreach ($charList as $chr) {
                ...
                $apis =
                    $this->accessMask->maskToAPIs($chr['mask'], $this->section);
                if ($apis === false) {
                ...
                foreach ($apis as $api) {
                    ...
                    if (CachedUntil::cacheExpired($api, $chr['keyID']) === false
                    ) {
                        continue;
                    }
                    ++$apiCount;
                    ...
                    set_time_limit(60);
                    /**
                     * @var \Yapeal\Database\AbstractApiRequest $instance
                     */
