...
class RegisteredKey extends ALimitedObject implements IGetBy
{
    ...
    public function addActiveAPI($name, $section = null)
    {
        ...
        // If no section parameter see if key type is known from Yapeal\Database\Account\APIKeyInfo.
    ...
    public function getItemById($id)
    {
        ...
        try {
            ...
            if (!empty($result)) {
                ...
                // Get accessMask from Yapeal\Database\Account\APIKeyInfo if available.
    ...
    /**
     * @var AccessMask Hold an instance of the AccessMask class.
     */
    protected $am;
    /**
    ...
    protected $con;
    /**
     * @var QueryBuilder Holds query builder object.
     */
    protected $qb;
    /**
    ...
    /**
     * $var string Holds the type returned when querying APIKeyInfo.
     */
    private $type;
}
