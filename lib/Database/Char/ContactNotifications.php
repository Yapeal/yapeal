 ...
 */
class ContactNotifications extends AbstractCommonEveApi
{
    ...
    protected function preserve(
        ...
        try {
            $this->getPdo()
                 ->beginTransaction();
            $this->preserverToContactNotifications($preserver, $xml, $ownerID);
            $this->getPdo()
                 ->commit();
        } catch (PDOException $exc) {
            $mess = sprintf(
     ...
     * @return self
     */
    protected function preserverToContactNotifications(
        ...
        $preserver->setTableName('charContactNotifications')
