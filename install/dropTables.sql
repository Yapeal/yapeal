...
DROP TABLE IF EXISTS `charAttackers` ;
...
DROP TABLE IF EXISTS `charKillLog` ;
...
DROP TABLE IF EXISTS `charVictim` ;
...
DROP TABLE IF EXISTS `corpAttackers` ;
...
DROP TABLE IF EXISTS `corpItems` ;
DROP TABLE IF EXISTS `corpKillLog` ;
...
DROP TABLE IF EXISTS `corpVictim` ;
