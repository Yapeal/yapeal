<?php
/**
 * Class used to fetch and store char Research API.
 *
 * PHP version 5
 *
...
class charMailingLists extends ACharacter {
   ...
   */
  private $types = array('agentID' => 'I', 'ownerID' => 'I',
    'pointsPerDay' => 'N', 'skillTypeID' => 'I', 'remainderPoints' => 'F',
    'researchStartDate' => 'T'
  );
  /**
  ...
  private $xpath = '//row';
  /**
   * Used to store XML to Research table.
   *
