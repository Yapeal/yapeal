...
CREATE PROCEDURE "{database}"."AddOrModifyColumn"(
    IN param_database_name VARCHAR(100), IN param_table_name VARCHAR(100),
    IN param_column_name   VARCHAR(100), IN param_column_details VARCHAR(255))
    BEGIN
