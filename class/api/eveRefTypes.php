<?php
/**
 * Class used to fetch and store RefTypes API.
 *
 * PHP version 5
 *
 ...
 * @subpackage Api_eve
 */
class eveRefTypes implements IFetchApiTable, IStoreApiTable {
  /**
   * @var string Holds the name of the API.
   */
  protected $api = 'RefTypes';
  /**
   ...
   */
  private $types = array('refTypeID' => 'I', 'refTypeName' => 'C');
  /**
