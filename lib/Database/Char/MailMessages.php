 ...
 * Class MailMessages
 */
class MailMessages extends AbstractCommonEveApi
{
    ...
    protected function preserve(
        ...
        try {
            $this->getPdo()
                 ->beginTransaction();
            $this->preserverToMailMessages($preserver, $xml, $ownerID);
            $this->getPdo()
                 ->commit();
        } catch (PDOException $exc) {
            $mess = sprintf(
     ...
     * @return self
     */
    protected function preserverToMailMessages(
        ...
        $preserver->setTableName('charMailMessages')
