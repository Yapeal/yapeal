 ...
 * Class Standings
 */
class Standings extends AbstractCorpSection
{
    ...
    protected function preserverToAgents($xml, $ownerID)
    {
        ...
        $tableName = 'corpStandingsFromAgents';
        $sql = $this->getCsq()
    ...
    protected function preserverToFactions($xml, $ownerID)
    {
        ...
        $tableName = 'corpStandingsFromFactions';
        $sql = $this->getCsq()
                    ->getDeleteFromTableWithOwnerID($tableName, $ownerID);
        $this->getLogger()
             ->info($sql);
    ...
    protected function preserverToNpcCorporations($xml, $ownerID)
    {
        ...
        $tableName = 'corpStandingsFromNPCCorporations';
        $sql = $this->getCsq()
                    ->getDeleteFromTableWithOwnerID($tableName, $ownerID);
        $this->getLogger()
             ->info($sql);
